...
export default function MyReportsClient({ initialIssues }: MyReportsClientProps) {
  ...
  // Available unique options for filtering
              ...
              {paginatedIssues.length === 0 ? (
                <tr>
                  <td colSpan={8} className="p-12 text-center text-muted">
                    ...
                    <p className="text-xs mt-0.5">Try resetting the filters or typing a different search query.</p>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={issue.id} className="hover:bg-muted-background/15 transition-colors">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-foreground line-clamp-2 max-w-[200px] sm:max-w-xs">
                          {issue.title}
                        </span>
                      </div>
                    </td>
                    ...
                    {/* Category */}
                    <td className="p-4 text-muted-text font-medium">{issue.category}</td>
                    ...
                    <td className="p-4 text-center">
                      <Link
                        ...
                        title="View Report Investigation Details"
                      >
